...
const Navbar = () => {
  ...
  const NavLinks =<>
  <li>
        <NavLink to='/' className=" bg-slate-200 flex gap-5 py-2 pl-3 pr-4 text-white   md-bg-transparent md-text-blue-700 md-p-0 md-dark-text-blue-500" aria-current="page">
          Home</NavLink>
      </li>
      <li>
      ...
      <li>
        <NavLink to='/register' className="bg-slate-200 hover:bg-blue-400  block py-2 pl-3 pr-4 text-gray-900  hover-bg-gray-100 md-hover-bg-transparent md-hover-text-blue-700 md-p-0 dark-text-white md-dark-hover-text-blue-500 dark-hover-bg-gray-700 dark-hover-text-white md-dark-hover-bg-transparent dark-border-gray-700">
        lregister</NavLink>
      </li>
      <li>
        <button className="bg-slate-200 hover:bg-blue-400  block py-2 pl-3 pr-4 text-gray-900  hover-bg-gray-100 md-hover-bg-transparent md-hover-text-blue-700 md-p-0 dark-text-white md-dark-hover-text-blue-500 dark-hover-bg-gray-700 dark-hover-text-white md-dark-hover-bg-transparent dark-border-gray-700">
        logout</button>
      </li>
      <li>
