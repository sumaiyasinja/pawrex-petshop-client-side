        ...
        {user ? (
          ...
          <li>
            ...
            <ul className={`${open ? "block" : "hidden"} absolute`}>
              <li>
                <NavLink to='/manage' className="bg-slate-200 hover:bg-blue-300 block py-2 pl-3 pr-4 text-gray-900 hover-bg-gray-100 md-hover-bg-transparent md-hover-text-blue-700 md-p-0 dark-text-white md-dark-hover-text-blue-500 dark-hover-bg-gray-700 dark-hover-text-white md-dark-hover-bg-transparent dark-border-gray-700">
                  My Services
                </NavLink>
              </li>
              <li>
      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900 sm:mb-20">
        <div className="max-w-screen-xl flex flex-col lg:flex-wrap lg:flex-row gap-6 md:gap-9 lg:gap-2  items-center justify-between mx-auto p-4">
          ...
          <div className="items-center justify-between w-full md:flex md:w-auto" id="navbar-user">
            <ul className="cursor-pointer flex font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md-flex-row md-space-x-8 md-mt-0 md-border-0 md-bg-white dark-bg-gray-800 md-dark-bg-gray-900 dark-border-gray-700">
              {/* Navbar */}
              {NavLinks}
            </ul>
          </div>
          {
            ...
            <button type="button" 
            className="avatar w-9 online flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 border-none dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
